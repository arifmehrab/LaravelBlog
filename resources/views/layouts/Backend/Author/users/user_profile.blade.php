                        ...
                        <div class="card">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="settings" role="tabpanel">
                                    <div class="card-body">
                                        <form class="form-horizontal form-material" action="{{ route('author.profile.update') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-group">
                                                <label class="col-md-12">Full Name</label>
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="Enter Your Name" class="form-control form-control-line" name="name" value="{{ $user->name }}">
                                                    <!-- Error Message -->
                                                    @error('name')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="email" placeholder="Enter Your Email" class="form-control form-control-line" name="email" id="example-email" value="{{ $user->email }}">
                                                    <!-- Error Message -->
                                                    @error('email')
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                    @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="Enter Your Address" class="form-control form-control-line" name="address" value="{{ $user->address }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <!-- Auth Image -->
                                                    <img width="50" src="{{ asset('Backend/assets/images/profile/'. $user->profile) }}">
                                                    <!-- Error Message -->
                                                    @error('image')
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                    @enderror
                                ...
                                <div class="tab-pane" id="changePassword" role="tabpanel">
                                    <div class="card-body">
                                        <form class="form-horizontal form-material" action="{{ route('author.password.update') }}" method="post">
                                            @csrf
                                            <div class="form-group">
