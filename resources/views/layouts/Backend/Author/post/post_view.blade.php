...
<div class="row">
	<div class="col-12">
		<div class="card">
			 <div class="card-body">
			 	<a class="btn btn-primary my-3" href="{{ route('author.post.create') }}">
			 		...
			 		<table id="myTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        	...
                        	<tr>
                        		...
                        		<td>
                        			<a title="Edit" class="btn btn-success" href="{{ route('author.post.edit', $post->id) }}">
                        				<i class="fa fa-edit"></i>
                        			</a>
                                    <a title="View" class="btn btn-primary" href="{{ route('author.post.show', $post->id) }}">
                                        <i class="fas fa-eye"></i>
                                    </a>
                      	            <button title="Delete" type="button" class="btn btn-danger" onclick="deleteTag({{ $post->id }})">
                      	            	<i class="fa fa-trash"></i>
                      	            </button>
                      	            <form style="display: none;" id="delete_form_{{ $post->id }}" method="post" action="{{ route('author.post.destroy', $post->id) }}">
                      	            	@csrf
                      	            	@method('DELETE')
                      	            </form>
                        		</td>
