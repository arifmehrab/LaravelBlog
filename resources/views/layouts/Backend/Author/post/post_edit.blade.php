    	...
    	<div class="col-md-8">
			<div class="card">
				<div class="card-body">
                    ...
                    <div class="form-group m-b-40">
                    		<input type="checkbox" class="custom-control-input" name="publish" value="1" id="defaultUnchecked" {{ $post->status == '1' ? 'checked':'' }}>
                    		<label class="custom-control-label" for="defaultUnchecked">Published</label>
                    </div>
