...
<div class="row">
	<div class="col-12">
		<div class="card">
			 <div class="card-body">
                <h4 class="text-right" style="font-size: 25px; font-weight: bold;">Total Subscribers:- {{ $subscribers->count() }}
                </h4>
			 		...
			 		<table id="myTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        	...
                        	<tr>
                               ...
                               <td>{{ $subscriber->created_at->diffForHumans() }}
                               </td>
                        		<td>
                                    <button title="Delete" type="button" class="btn btn-danger" onclick="deleteTag({{ $subscriber->id }})">
                      	            	<i class="fa fa-trash"></i>
                      	            </button>
                      	            <form style="display: none;" id="delete_form_{{ $subscriber->id }}" method="post" action="{{ route('admin.subscriber.destroy', $subscriber->id) }}">
                      	            	@csrf
                      	            	@method('DELETE')
                      	            </form>
                        		</td>
