	...
	<div class="col-12">
		<div class="card">
			 <div class="card-body">
                ...
                <h4 class="text-right" style="font-size: 25px; font-weight: bold;">Total Post:- {{ $comments->count() }}
                </h4>
                        ...
                        <tbody>
                        	...
                        	<tr>
                        		...
                        		<td>
                      	            ...
                      	            <form style="display: none;" id="delete_form_{{ $comment->id }}" method="post" action="{{ route('admin.comment.destroy', $comment->id) }}">
                                        @csrf
                                        @method('DELETE')
                      	            </form>
                        		</td>
